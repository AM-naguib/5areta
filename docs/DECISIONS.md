...
### D-016 — Separate product-sales cash balance
Status: Confirmed

Money generated by product sales must be tracked in a dedicated product-sales balance that is separate from the main shop vault. Product-sale cash must not automatically increase the main-vault balance. The exact composition of this product balance (full sale cash vs profit-only balance) is still to be confirmed separately.
...
## Open decisions
- Exact composition of the separate product-sales balance: full sale cash, profit only, or both reported separately.
